...
public class Checkout extends Activity {
	...
	e4 = (EditText) findViewById(R.id.etm);e5 = (EditText) findViewById(R.id.refcode);
		e4.setText(getIntent().getStringExtra("colg"));
						...
						public void onClick(DialogInterface dialog,int id) {
							...
							Intent email = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:storetethys@yahoo.com"));
							 ...
							 email.putExtra(Intent.EXTRA_TEXT,s+check);
								Intent i = new  Intent(Checkout.this,AutoSelect.class);
